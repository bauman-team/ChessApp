...
MovesInfo Figure::FindPossibleMovesKing(const Pos& figurePosition, const FigureType figureType, Map& map) noexcept
{
	MovesInfo possibleMoves;
...
MovesInfo Figure::FindPossibleMovesQueen(const Pos& figurePosition, const FigureType figureType, Map& map) noexcept
{
...
MovesInfo Figure::FindPossibleMovesBishop(const Pos& figurePosition, const FigureType figureType, Map& map) noexcept
{
	return FindDiagonalMoves(figurePosition, figureType, map);
}

MovesInfo Figure::FindPossibleMovesKnight(const Pos& figurePosition, const FigureType figureType, Map& map) noexcept
{
	MovesInfo possibleMoves;
	auto figureColor{ GetFigureTypeColor(figureType) };
	auto possibleCastling{ map.GetPossibleCastling() };
...
MovesInfo Figure::FindPossibleMovesRook(const Pos& figurePosition, const FigureType figureType, Map& map) noexcept
{
	return FindStraightMoves(figurePosition, figureType, map);
}

MovesInfo Figure::FindPossibleMovesPawn(const Pos& figurePosition, const FigureType figureType, Map& map) noexcept
{
	MovesInfo possibleMoves;
	auto possibleCastling{ map.GetPossibleCastling() };
	auto movesCount{ static_cast<uint16_t>(map.GetMovesCount() + 1) };
...
MovesInfo Figure::FindStraightMoves(const Pos& figurePosition, const FigureType figureType, Map& map) noexcept
{
	MovesInfo possibleMoves;
	auto figureColor{ GetFigureTypeColor(figureType) };
...
MovesInfo Figure::FindDiagonalMoves(const Pos& figurePosition, FigureType figureType, Map& map) noexcept
{
	MovesInfo possibleMoves;
	auto figureColor{ GetFigureTypeColor(figureType) };
	auto possibleCastling{ map.GetPossibleCastling() };
...
void Figure::EraseForbiddenMoves(MovesInfo& allFiguresMoves, Map& map) noexcept
{
...
MovesInfo Figure::FindPossibleMoves(const Pos& figurePosition, FigureType figureType, Map& map) noexcept
{
